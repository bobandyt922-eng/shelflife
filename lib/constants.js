...
export const goldDark = "#a07830";
export const cardBg = "var(--card-bg)";
export const borderClr = "var(--border-clr)";
...
export const btnPrimary = { background:`linear-gradient(135deg, ${gold}, ${goldDark})`, color:"#1a1a1a", border:"none", padding:"12px 28px", borderRadius:6, cursor:"pointer", fontFamily:"'Cinzel', serif", fontWeight:700, fontSize:14, letterSpacing:1, textTransform:"uppercase" };
export const btnGhost = { ...btnPrimary, background:"transparent", color:"var(--text-sub)", border:"1px solid var(--border-clr)", fontSize:12, padding:"10px 20px" };
export const btnDanger = { ...btnPrimary, background:"linear-gradient(135deg, #944, #722)", color:"#fff", fontSize:12, padding:"10px 20px" };
export const btnSmall = { background:"none", border:"1px solid var(--border-clr)", color:"var(--text-sub)", padding:"6px 14px", borderRadius:4, cursor:"pointer", fontSize:11, fontFamily:"'Cinzel', serif", letterSpacing:0.5, textTransform:"uppercase" };
export const inputBase = { width:"100%", background:"var(--input-bg)", border:"1px solid var(--border-clr)", color:"var(--text)", padding:"12px 14px", borderRadius:6, fontSize:15, fontFamily:"'EB Garamond', serif", boxSizing:"border-box" };
export const selectBase = { ...inputBase, appearance:"auto" };
export const labelBase = { display:"block", fontSize:10, textTransform:"uppercase", letterSpacing:2, color:gold, marginBottom:4, fontFamily:"'Cinzel', serif" };
export const emptyBook = { title:"",author:"",publisher:"",editionType:"",limitation:"",condition:"Mint",purchasePrice:"",currentValue:"",notes:"",coverUrl:"",isbn:"" };

export const SHELF_VALUATION_SOURCE = "Shelf Valuation";
export const FOLLOW_TABLE_CANDIDATES = ["collector_follows", "user_follows", "follows"];
